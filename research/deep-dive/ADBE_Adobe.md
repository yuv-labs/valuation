...
| **Op margin** | 36.6% | 30.0% → 36.6% ↑ | FY2024 일시 하락 후 V자 회복 |
...
| R2 | **매출 성장 둔화** | FY2025 +11% → FY2026 매출 가이던스 +8.9-9.8%, ARR 가이던스 +10.2%. Net new DM ARR $400M (컨센서스 $450-460M 하회) | FY2026 가이던스 (공시) |
...
| R2 | 매출 성장 둔화 — 가이던스 +8.9-9.8%, Net new ARR $400M miss | **높음** | **중-높음** | Base 성장률 9% | 매출 YoY, net new ARR |
