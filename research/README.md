...
- `buffett/shallow-dive/`, `buffett/deep-dive/` — Buffett/Graham 프레임 리포트
- `fisher/shallow-dive/`, `fisher/deep-dive/` — Fisher 프레임 리포트 (빈 상태, Fisher 템플릿 완성 후 작성 예정)
- `_template.md` — 공통 메타데이터 스캐폴딩
- `192080-KS.md` — 프레임 미배정 단일 리포트
- 프레임·프로세스·템플릿 문서는 `../playbook/` (buffett/, fisher/ 내부 분리)
...
| 단계 | 의미 |
|------|------|
| Shallow | Shallow Dive 리포트 작성됨 |
| Deep | Deep Dive 리포트 작성됨 |
